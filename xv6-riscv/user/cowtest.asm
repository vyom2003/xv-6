...
simpletest()
{
  ...
  2a:	7ce080e7          	jalr	1998(ra) # 7f4 <sbrk>
  ...
  42:	7ae080e7          	jalr	1966(ra) # 7ec <getpid>
  46:	c088                	sw	a0,0(s1)
  for(char *q = p; q < p + sz; q += 4096){
  ...
  72:	786080e7          	jalr	1926(ra) # 7f4 <sbrk>
  76:	57fd                	li	a5,-1
...
threetest()
{
 ...
 128:	6d0080e7          	jalr	1744(ra) # 7f4 <sbrk>
  if(p == (char*)0xffffffffffffffffL){
 12c:	57fd                	li	a5,-1
 ...
 150:	6a0080e7          	jalr	1696(ra) # 7ec <getpid>
 ...
 16e:	692080e7          	jalr	1682(ra) # 7fc <sleep>
 ...
 17c:	674080e7          	jalr	1652(ra) # 7ec <getpid>
 ...
 192:	666080e7          	jalr	1638(ra) # 7f4 <sbrk>
 196:	57fd                	li	a5,-1
 ...
 210:	5e0080e7          	jalr	1504(ra) # 7ec <getpid>
 ...
 228:	5c8080e7          	jalr	1480(ra) # 7ec <getpid>
...
filetest()
{
 ...
 3c8:	438080e7          	jalr	1080(ra) # 7fc <sleep>
 ...
 3f2:	40e080e7          	jalr	1038(ra) # 7fc <sleep>
      if(j != i){
...
stat(const char *n, struct stat *st)
{
 ...
 632:	17e080e7          	jalr	382(ra) # 7ac <open>
  if(fd < 0)
 ...
 642:	186080e7          	jalr	390(ra) # 7c4 <fstat>
 646:	892a                	mv	s2,a0
  close(fd);
 648:	8526                	mv	a0,s1
 64a:	00000097          	auipc	ra,0x0
 64e:	14a080e7          	jalr	330(ra) # 794 <close>
  return r;
}
 652:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 ca2:	b56080e7          	jalr	-1194(ra) # 7f4 <sbrk>
  if(p == (char*)-1)
