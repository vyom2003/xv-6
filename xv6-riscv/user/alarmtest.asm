...
stat(const char *n, struct stat *st)
{
 ...
 5c2:	17e080e7          	jalr	382(ra) # 73c <open>
  if(fd < 0)
 ...
 5d2:	186080e7          	jalr	390(ra) # 754 <fstat>
 5d6:	892a                	mv	s2,a0
  close(fd);
 5d8:	8526                	mv	a0,s1
 5da:	00000097          	auipc	ra,0x0
 5de:	14a080e7          	jalr	330(ra) # 724 <close>
  return r;
}
 5e2:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 c32:	b56080e7          	jalr	-1194(ra) # 784 <sbrk>
  if(p == (char*)-1)
