...
int main()
{
  ...
  82:	38a080e7          	jalr	906(ra) # 408 <sleep>
  ...
  c6:	2d6080e7          	jalr	726(ra) # 398 <waitx>
...
stat(const char *n, struct stat *st)
{
 ...
 23e:	17e080e7          	jalr	382(ra) # 3b8 <open>
  if(fd < 0)
 ...
 24e:	186080e7          	jalr	390(ra) # 3d0 <fstat>
 252:	892a                	mv	s2,a0
  close(fd);
 254:	8526                	mv	a0,s1
 256:	00000097          	auipc	ra,0x0
 25a:	14a080e7          	jalr	330(ra) # 3a0 <close>
  return r;
}
 25e:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 8ae:	b56080e7          	jalr	-1194(ra) # 400 <sbrk>
  if(p == (char*)-1)
